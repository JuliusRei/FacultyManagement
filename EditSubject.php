...
<button type = "submit" class = "btn btn-sm btn-success" name = "btnEdit" value='<?php echo $row->strSubjectCode; ?>' onclick="return confirm('Do you want to save these changes?')">Save Record</button>
